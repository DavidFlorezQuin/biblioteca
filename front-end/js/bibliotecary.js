document.addEventListener('DOMContentLoaded', function () {
  ...
  function save(){
    ...
    const workSchule = document.getElementById('horario').value;
  ...
  function deleteById(id) {
    fetch('http://localhost:9000/library/v1/api/bibliotecary/' + id, {
      method: 'DELETE',
      headers: {
        'Content-Type': 'application/json'
      }
  ...
  function findById(id) {
    ...
    .then(response => {
      ...
      .then(data => {
        ...
        document.getElementById('salary').value = datos.salary;
        document.getElementById('password').value = datos.password;
        document.getElementById('horario').value = datos.workSchedule;
